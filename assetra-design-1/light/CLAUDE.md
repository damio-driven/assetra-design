...
Usa immagini stock **royalty-free di alta qualità** da Unsplash/Pexels con query:
- Hero: `luxury office interior design`, `contemporary hospitality lounge`
- Portfolio: `modern retail interior`, `hotel lobby design`, `corporate office furniture`
- About: `business meeting elegant space`, `interior design consultation`

Usa sempre `loading="lazy"` e `width`/`height` espliciti per evitare CLS.
